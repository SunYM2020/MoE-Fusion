...
class DecMoE(nn.Module):
    ...
    def __init__(self, ds_inputsize, input_size, output_size, num_experts, hidden_size, noisy_gating=True, k=4, trainingmode=True):
        ...
        self.k = k
        # instantiate experts
        self.experts = nn.ModuleList([DecoderLayer(self.input_size, self.output_size, self.hidden_size) for i in range(self.num_experts)])
    ...
    def forward(self, x_ds, x, loss_coef=1e-2):
        """Args:
