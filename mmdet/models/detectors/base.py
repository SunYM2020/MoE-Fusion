...
class BaseDetector(nn.Module):
    ...
    @property
    def with_selfrep_r(self):
        return hasattr(self, 'fusion_head_r') and self.fusion_head_r is not None

    @property
    def with_selfrep_i(self):
        return hasattr(self, 'fusion_head_i') and self.fusion_head_i is not None
